...
public class cargaDatosWS {
    private String conexion =  "http://192.168.1.105:8080/BacTechnology/BacTechnologyService?WSDL";
    ...
    public boolean guardarReporte(String idMaquina, String idMolde, String idUsuario, String imagen,String novedad,String solucion,String tipoNovedad, String tipoSolucion,String novedadDetectada, int tipo){
        boolean res = false;
        SoapObject rpc;
        ...
        propertyTipoReporte.name = "tipoReporte";
        propertyTipoReporte.type = PropertyInfo.INTEGER_CLASS;
        propertyTipoReporte.setValue(tipo);
