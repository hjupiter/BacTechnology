...
public class MaquinaMolde extends AppCompatActivity {
    ...
    private class DownloadTask2 extends AsyncTask<String,Void,Object> {
        ...
        protected Integer doInBackground(String... args) {
            ...
            Boolean a = ws.guardarReporte(idMaquina,idMolde,usuario,strBase64,reporteNovedad.getText().toString(),reporteSolucion.getText().toString(),opNovedad,opSolucion,novedadDetectada,1);
